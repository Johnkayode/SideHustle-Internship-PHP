<?php
    ...
    /*
        Major Task for Week 1 Side Hustle Internship
    */
    ...
    echo '<p>This program subtracts two variables from each other</p>';
    ...
    echo '<p>This program multiplies two variables together</p>';
